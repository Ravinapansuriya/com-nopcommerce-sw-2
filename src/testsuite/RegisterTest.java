...
public class RegisterTest extends BaseTest {
    ...
    public void userShouldRegisterAccountSuccessfully() {
        ...
        //Enter First name
        driver.findElement(By.xpath("//input[starts-with(@id, 'FirstName')]")).sendKeys("ravi");
        ...
        driver.findElement(By.xpath("//input[@id= 'Email'] ")).sendKeys("ravi89@gmail.com");

        //Enter the Company details
        driver.findElement(By.xpath("//input[@id='Company'] ")).sendKeys("apple");

        // //Enter the password field
        driver.findElement(By.xpath("//input[@type= 'password'][@id= 'Password']")).sendKeys("ravi@1234");

        // //Enter the password field
        driver.findElement(By.xpath("//input[@type= 'password'][@id= 'ConfirmPassword']")).sendKeys("ravi@1234");
