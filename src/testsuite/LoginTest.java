...
public class LoginTest extends BaseTest {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials() {
        ...
        driver.findElement(By.xpath("//input[@class='email'] ")).sendKeys("rv@gmail.com");

        // //Enter the password field
        driver.findElement(By.xpath("//input[@id='Password']")).sendKeys("rv1234");
    ...
    public void verifyErrorMessage() {
        ...
        // //Enter the password field
        driver.findElement(By.xpath("//input[@id='Password']")).sendKeys("ravina1");
